...
<div id="content" class="bg-light">
    ...
    <section class="content-header px-2 ">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h2 class="fw-lighter">List Of States</h2>
                </div>
                <div class="col-sm-6 text-end">
                    <a class="btn btn-outline-dark" id="btn-add-state">Add</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="row m-2 rounded">
                <div class="card border-0 m-p">
                    <table class="table table-striped" id="table-state">
                        <thead>
                            <tr>
...
<script src="<?php echo base_url('public/js/state.js') ?>"></script>
<?php
echo view('dashboard/modals/add_state_modal');
echo view('dashboard/modals/edit_state_modal');
